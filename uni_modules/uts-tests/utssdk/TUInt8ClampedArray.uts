...
export class TUint8ClampedArray {
  ...
  testEvery() {
    ...
    let result = new Uint8ClampedArray([12, 5, 8, 130, 44]).every((value: number, _: number, _:
  ...
  testFilter() {
    ...
    let float32 = new Uint8ClampedArray([12, 5, 8, 44]).filter((value: number, _: number, _:
  ...
  find() {
    ...
    let res = float32.find((value: number, _: number, _: Uint8ClampedArray): boolean => value > 5);
    expect(res).toEqual(8);
  }

  findIndex() {
    let float32 = new Uint8ClampedArray([4, 6, 8, 12]);
    let res = float32.findIndex((value: number, _: number, _: Uint8ClampedArray): boolean => value > 100);
    expect(res).toEqual(-1);

    let ufloat32 = new Uint8ClampedArray([4, 6, 7, 120]);
    res = ufloat32.findIndex((value: number, _: number, _: Uint8ClampedArray): boolean => value > 100);
  ...
  map() {
    ...
    let doubles = numbers.map((value: number, _: number, _: Uint8ClampedArray): number => value * 2);
  ...
  reduce() {
    ...
    res = total.reduce((accumulator: number, currentValue: number, _: number, _: Uint8ClampedArray):
